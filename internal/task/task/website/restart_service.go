...
func NewRestartServiceTask(curveadm *cli.CurveAdm, cfg *configure.WebsiteConfig) (*task.Task, error) {
	...
	t := task.NewTask("Restart Website Service", subname, hc.GetSSHConfig())
