...
var (
	...
	ERR_DELETE_CLIENT_FAILED           = EC(113002, "execute SQL failed which delete client")
	ERR_GET_ALL_CLIENTS_FAILED         = EC(113003, "execute SQL failed which get all clients")
	ERR_GET_CLIENT_BY_ID_FAILED        = EC(113004, "execute SQL failed which client by id")
	// 114: database/SQL (execute SQL statement: playground table)
	ERR_GET_ALL_PLAYGROUND_FAILED     = EC(114000, "execute SQL failed which get all playgrounds")
	ERR_GET_PLAYGROUND_BY_NAME_FAILED = EC(114001, "execute SQL failed which get playground by name")
	ERR_INSERT_PLAYGROUND_FAILED      = EC(114002, "execute SQL failed which insert playground")
	...
	// 340: configure (topology.yaml: parse failed)
	...
	// 341: configure (topology.yaml: invalid configure value)
	...
	ERR_ADD_MODUDLE_FROM_LINUX_KERNEL_FAILED       = EC(620021, "add module from linux kernel failed")
