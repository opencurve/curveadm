...
var (
	...
	ERR_VOLUME_DISK_EXIST                 = EC(420009, "the disk has been mapped")
	ERR_DISK_MAP_EXIST                    = EC(420010, "[Tips] Mapping %s the disk is still the first time it has been created")
