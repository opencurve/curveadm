...
func (admCfg *CurveAdmConfig) GetSudoAlias() string {
	if len(admCfg.SudoAlias) == 0 {
		return WITHOUT_SUDO
	}
	return admCfg.SudoAlias
}

func (admCfg *CurveAdmConfig) GetSSHTimeout() int {
	return admCfg.SSHTimeout
}
